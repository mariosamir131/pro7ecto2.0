...
<div class="container mt-5">
    <div class="container mt-5  ">
    <h2 class="titleF">Eliga una opcion para que base de datos quiere trabajar</h2>
    <br>
    <div class="container mt-5">
    <a href="tablaO.php"><img src="imagenes/mysqlonline" width="400px" heigth="400px"></a>
    <p class="contenido">
        Base de Datos en Linea
    </p>
    </div>
    <div class="container mt-5">
    <a href="tablaL.php"><img src="imagenes/bd" width="400px" heigth="400px"></a>
    <p class="contenido">
        Base de Datos Local
    </p>
    </div>
